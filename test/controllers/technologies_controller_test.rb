...
class TechnologiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create technology" do
    assert_difference("Technology.count") do
      post technologies_url, params: { technology: { name: @technology.name, portfolio_id: @technology.portfolio_id } }
    end
  ...
  test "should update technology" do
    patch technology_url(@technology), params: { technology: { name: @technology.name, portfolio_id: @technology.portfolio_id } }
