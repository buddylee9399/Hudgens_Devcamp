...
class PortfoliosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create portfolio" do
    assert_difference("Portfolio.count") do
      post portfolios_url, params: { portfolio: { body: @portfolio.body, position: @portfolio.position, subtitle: @portfolio.subtitle, title: @portfolio.title } }
    end
  ...
  test "should update portfolio" do
    patch portfolio_url(@portfolio), params: { portfolio: { body: @portfolio.body, position: @portfolio.position, subtitle: @portfolio.subtitle, title: @portfolio.title } }
